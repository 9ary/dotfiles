...
-- Config dir path to avoid hardcoding
local cpath = os.getenv("HOME") .. "/.config/awesome/"
...
beautiful.init(cpath .. "theme/theme-solarized.lua")
...
editor_cmd = editor
file_manager = "caja "
file_manager_open = file_manager .. "--browser "
...
myawesomemenu = {
   ...
   { "Configuration directory", file_manager_open .. cpath },
