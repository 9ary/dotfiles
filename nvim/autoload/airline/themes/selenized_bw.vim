...
let s:term_cyan = 6
let s:term_orange = s:term_yellow " FIXME
let s:term_violet = s:term_magenta " FIXME
...
let s:term_br_orange = s:term_br_yellow " FIXME
let s:term_br_violet = s:term_br_magenta " FIXME
